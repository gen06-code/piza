                ...
                <form action="{{route('pizza.store')}}" method="post" enctype="multipart/form-data">@csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-inline">
                            ...
                            <input type="numeric" name="small_pizza_price" class="form-control" placeholder="small pizza price">
                            <input type="numeric" name="medium_pizza_price" class="form-control" placeholder="medium pizza price">
                            <input type="numeric" name="large_pizza_price" class="form-control" placeholder="large pizza price">
                        </div>
